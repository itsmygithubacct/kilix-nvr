...
/*
 * Finding a bundled tool is kilix-sound-detect's ksd_bundled_tool(): one
 * implementation of "beside the executable, then the checkout's tools/,
 * then PATH", not two that drift.
 */
